...
export function ScanFunnelCard() {
  ...
  return <section className="panel" style={{padding:24}}>
    ...
    <p>Alpaca SIP · первые 5 минут · история 14 сессий · только покупки</p>
