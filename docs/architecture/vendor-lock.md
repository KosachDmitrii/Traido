...
Data URL: `https://data.alpaca.markets`; `ALPACA_DATA_FEED=iex` for development or
`ALPACA_DATA_FEED=sip` only when the configured credentials prove SIP entitlement.
